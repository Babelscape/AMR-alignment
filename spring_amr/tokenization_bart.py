...
class AMRBartTokenizer(BartTokenizerFast):
    INIT = 'Ġ'
    ...
    def __init__(self, *args, use_pointer_tokens=False, collapse_name_ops=False, **kwargs):
        ...
        self.special_tokens_list = [self.bos_token, self.eos_token, self.pad_token, '<mask>', '<unk>']
    ...
    def linearize(self, graph):
        ...
        token_ids.insert(0, self.convert_tokens_to_ids(self.bos_token))
...
class OLDAMRBartTokenizer(BartTokenizer):
...
class OLDPENMANBartTokenizer(OLDAMRBartTokenizer):
